...
<body>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden"  name="id" id="edid">
                               <div class="form-group">
                            	<label for="edfname">doctor  First Name</label>
                            ...
                            <div class="form-group">
                            	<label for="edlname">Doctor last name</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="edaddress" required class="form-control" id="adress" name="address" aria-describedby="doctor adress" placeholder="address" required autofocus>
                            </div>
                            <div class="form-group">
                            	<label for="edquali">Qualification</label>
                                <input type="text" id="edquali" required class="form-control" id="qualifiction" name="qualification" aria-describedby="doctor qualification" placeholder="add doctor qualificationd" required autofocus>
                            </div>
    ...
    <center><h2>Doctor Details</h2></center>
        <table class="table table-striped table-responsive-sm">
                <thead>
                  <tr>
                     <th scope="col">Doc_Fname</th>
                     <th scope="col">Doc_Lname</th>
                     <th scope="col">Doc_EmailId</th>
                     <th scope="col">Doc_MobileNo</th>
                     <th scope="col">Doc_Address</th>
                     <th scope="col">Doc_Qualifiaction</th>
                     <th scope="col">Doc_UserName</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <th scope="row">${l.qualification}</th>
                    <th scope="row">${l.username}</th>
                    <td>
                        <button type="button" class="btn btn-primary" onClick="modalOpen('${l.id}','${l.fname}','${l.lname}','${l.email}','${l.mobileno}','${l.address}','${l.qualification}','${l.username}')" data-toggle="modal">
                               Edit
                         </button>
                    </td>
                    <td>

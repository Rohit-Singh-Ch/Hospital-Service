												...
												<ul class="d-flex flex-row align-items-center justify-content-start">
													...
													<div class="dropdown">
                                                       <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Patient
                                                          ...
                                                          <li><a href="addpat">Add Patient</a></li>
                                                           <li role="presentation"> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addPatient">
  				Add Patient
			</button></li>
                                                          <li><a href="patlist">Patient List</a></li>
                                                         <li role="presentation"> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#disPat">
  				Discharge Date
			</button></li>
													...
													<div class="dropdown">
                                                       <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Appointment
                                                          <span class="caret"></span></button>
                                                          <ul class="dropdown-menu">
                                                          <li><a href="reacPage">Make Appointment</a></li>
                                                           <li role="presentation"> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#makeAppt">
  				Make Appointment
			</button></li>
			<li><a href="seeAppt">see Appointment</a></li>
												</ul>
											</nav>
                    ...
                    <div class="modal-body">
                        <form action="addpat" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" id="addRecFname" name="fname" aria-describedby="receptionist name" placeholder="Patient name" required autofocus>
                            </div>
                            <div class="form-group">
                            	<label for="addName">Last Name</label>
                                <input type="text" required class="form-control" id="addRecLname" name="lname" placeholder="Patient name"" required autofocus>
                            </div>
                            
                            <div class="form-group">
                             	<label for="mobileno">Mobile no</label>
                                <input type="text"   required class="form-control" name="mobile" placeholder="add mobile no" >
                            </div>
                            <div class="form-group">
...
<div class="modal fade" id="disPat" tabindex="-1" role="dialog" aria-labelledby="dispat" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        <form action="discharge" method="POST">
                            <div class="form-group">
                            	<label for="discharge">user Id</label>
                                <input type="text" required class="form-control" id="discharge" name="id" aria-describedby="receptionist name" placeholder="user id" required autofocus>
                            </div>
	...
	<div class="modal fade" id="makeAppt" tabindex="-1" role="dialog" aria-labelledby="addPatient" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addBookModalLabel">Add Receptionist</h5>
                    ...
                    <div class="modal-body">
                        <form action="appt" method="POST">
                            <div class="form-group">
                            	<label for="addName">First Name</label>
                                <input type="text" required class="form-control" id="fname" name="fname" aria-describedby="enter fname" placeholder="Patient name" required autofocus>
                            </div>
                            <div class="form-group">
                            	<label for="addName">Last Name</label>
                                <input type="text" required class="form-control" id="lname" name="lname" placeholder="enter lname"" required autofocus>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" required class="form-control" id="doctorName" name="doctorName" aria-describedby=" doctor name" placeholder="doctor name" required autofocus>
                            </div>
                            <div>
                             <label for="start">Start date:</label>

      <input type="date" id="start" name="date"value="2018-07-22"  min="2018-01-01" max="2018-12-31">
